    ...
    days: [
      ...
      },
      {
        ...
        items: [
          ...
          { time: "18:00~19:00", place: "링컨로드", transport: "🚶", activity: "링컨로드 가벼운 저녁", memo: "🍽️ 6/8 월요일 가벼운 저녁\n• Joe's Stone Crab은 월요일 휴무 → 6/7로 옮김\n• 다음날 5am 기상이라 가볍게\n• 추천: Frenchie's Diner, Joe's Pizza (Lincoln Rd), Pubbelly Sushi\n• Lincoln Road 보행자 거리 산책 겸 식사" },
          { time: "19:00~20:00", place: "링컨로드", transport: "🍝", activity: "저녁 식사 + 디저트" },
