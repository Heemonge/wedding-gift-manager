    ...
    days: [
      ...
      },
      {
        ...
        items: [
          ...
          { time: "09:00~10:00", place: "원월드 트레이드", transport: "🚇", activity: "09:00 타미스 워킹투어 시작", memo: "👟 8시간 워킹투어 (다리 사용 多)\n• 운동화 + 양말 두 켤레 (땀 차서 갈아신기)\n• 선크림 + 모자 + 선글라스 + 물병\n• 가이드에 따라 점심·간식 추천 따라가기\n• 팁: $10-15/인 정도 (한국가이드 관습)\n• 미팅 장소 사전 확인 (보통 원월드 입구 또는 9/11 메모리얼 풀)" },
    ...
    days: [
      {
        ...
        items: [
          ...
          { time: "17:00~18:00", place: "Airbnb (Glendale)", transport: "🏠", activity: "에어비앤비 체크인 + 휴식" },
      ...
      },
      {
        ...
        subtitle: "출국",
        items: [
          { time: "06:00~07:00", place: "Airbnb", transport: "🧳", activity: "기상 / 짐 최종 정리" },
          { time: "07:00~08:00", place: "Airbnb", transport: "🚗", activity: "에어비앤비 체크아웃" },
