    ...
    days: [
      ...
      },
      {
        ...
        items: [
          ...
          { time: "14:00~15:00", place: "메트 자유관람", transport: "🎨", activity: "메트 자유관람 (간단히) + 호텔로 출발" },
          { time: "15:00~16:00", place: "호텔", transport: "👗", activity: "호텔 정리 / 의상 / 헤어 / 메이크업 (스냅 준비)", memo: "👗 스냅 준비 (1시간)\n• 의상 갈아입기\n• 헤어·메이크업 단장\n• 짐·소지품 정리\n• 16시 칼같이 출발" },
          { time: "16:00~17:00", place: "→ DUMBO", transport: "🚇", activity: "호텔 → DUMBO 이동 (F선 York St역, ~40분)", memo: "🚇 호텔(44 St) → DUMBO\n• F선 또는 우버 (~35~45분)\n• F선 York St역 하차 → 도보 5분\n• 우버 ~$30-40 (16시 러시아워 시작 — 우버 더 추천)" },
      ...
      },
      {
        ...
        items: [
          ...
          { time: "09:00~10:00", place: "원월드 트레이드", transport: "🚇", activity: "09:00 타미스 워킹투어 시작 (8시간, 17시 종료)", memo: "👟 타미스 워킹투어\n• 미팅: 09:00 / 199 Fulton St (원월드 트레이드 앞)\n• 종료: 17:00 / Washington Square S\n• 운동화 + 양말 두 켤레 + 물병\n• 선크림·모자·선글라스\n• 첼시마켓 점심 추천: Los Tacos No.1\n• 팁: $10~15/인" },
      ...
      },
      {
        ...
        items: [
          ...
          { time: "19:00~22:30", place: "브로드웨이", transport: "🎭", activity: "해리포터 브로드웨이 공연 (3시간 30분)", memo: "🎭 해리포터와 저주받은 아이\n• 19:00 시작 → 22:30 종료 (인터미션 20분 포함)\n• 인터미션 = 화장실·음료 시간\n• 사진·영상 촬영 절대 금지\n• #KeepTheSecrets — 스토리 SNS 공유 금지" },
          { time: "22:30~23:00", place: "타임스스퀘어", transport: "🌃", activity: "타임스스퀘어 야경 → 호텔" },
        ],
      },
      {
        day: "5일차",
        ...
        items: [
          ...
          { time: "17:00~17:30", place: "Keens Steakhouse", transport: "🚶", activity: "Keens 17:30 예약 — 10~15분 일찍 도착", memo: "🥩 Keens Steakhouse — 17:30 예약 ✓\n• 72 W 36th St (Herald Square 근처)\n• 1885년부터 운영, 천장에 가득한 흡연 파이프\n• 드레스코드: 비즈니스 캐주얼 (셔츠/원피스 권장, 청바지 OK)\n• 시그니처: Mutton Chop (양고기) — 호불호 갈림\n• 무난한 선택: Prime Steak / Filet Mignon\n• 사이드 공유 권장 (Creamed Spinach, Hash Browns)\n• 팁 20% 자동 포함 흔함 — 영수증 'Service Charge' 확인" },
          { time: "17:30~19:00", place: "Keens Steakhouse", transport: "🥩", activity: "Keens 저녁 (1.5시간)" },
    ...
    days: [
      ...
      },
      {
        ...
        items: [
          ...
          { time: "13:00~14:30", place: "Versace Mansion", transport: "🍽️", activity: "Villa Casa Casuarina 런치", memo: "🍽️ Villa Casa Casuarina (베르사체 맨션)\n• 1116 Ocean Dr\n• 풀사이드 자리 예약 시 요청\n• 드레스코드: 스마트 캐주얼\n• 사진 명소: 입구 계단, 메달리온 풀\n• 식사 후 무료 투어 (제한적)" },
          { time: "14:30~15:30", place: "오션드라이브 + 아르데코", transport: "🚶", activity: "오션드라이브 + 아르데코 산책 (Versace 인근)", memo: "🏖️ Ocean Drive + Art Deco\n• Versace에서 바로 도보 시작 (같은 거리)\n• 아르데코 호텔 색감 사진 (Colony, Beacon, Park Central)\n• 'Welcome to Miami Beach' 표지판\n• 호객꾼 메뉴 보여줘도 무시 OK" },
          { time: "15:30~16:30", place: "호텔 풀", transport: "🏊", activity: "수영장 풀파티 (1시간만)", memo: "🏊 Loews Pool — 디너 일찍이라 1시간만\n• 16:30 칼같이 나와서 샤워" },
          { time: "16:30~17:00", place: "호텔", transport: "🚿", activity: "샤워 / 옷 갈아입기 + Joe's 출발" },
          { time: "17:00~19:00", place: "Joe's Stone Crab", transport: "🦀", activity: "🦀 Joe's Stone Crab 5시 예약 ✓", memo: "🦀 Joe's Stone Crab — 17:00 예약 ✓\n• 11 Washington Ave (호텔 도보 15분 또는 우버 5분)\n• 16:50까지 도착 (예약이라도 일찍 가서 체크인)\n• 6월은 스톤크랩 비시즌 (10/15~5/1) — 냉동 또는 메뉴 변경 가능\n• 시즌이라도 시그니처: Stone Crab Claws (소·중·대·점보)\n• 비시즌 대체: 피쉬, 스테이크, 크랩 케이크\n• 디저트 무조건: Key Lime Pie\n• 드레스코드: 비즈니스 캐주얼 (반바지 X)\n• 1인 $80~150, 카드 OK, 팁 20% 흔함 — 영수증 확인" },
          { time: "19:00~21:00", place: "호텔", transport: "🚖", activity: "호텔 복귀 / 휴식 / Sweet Liberty 갈 준비", memo: "💆 Joe's 끝나고 잠시 호텔에서 쉬는 시간\n• 옷 갈아입기·메이크업 수정\n• 폰 충전·물 마시기\n• 21시 Sweet Liberty 도착 목표" },
          ...
          { time: "23:00~00:00", place: "클럽", transport: "🚕", activity: "🪩 클럽", memo: "🪩 마이애미 클럽\n• LIV @ Fontainebleau — 유명, 입장료 $50+\n• E11even — 24시간 운영\n• Story / Basement — EDM\n• 21+ 여권 / 드레스코드 (운동화 X)\n• 음료 $20~30, 가방 작게\n\n🚖 새벽 호텔 복귀\n• 우버/리프트 (택시 X)\n• 호객 거절 (바가지)\n• 'Rideshare Pickup' 표지판에서 호출\n• 번호판·운전자 사진 확인 후 탑승\n• 2인 함께 (절대 따로 X)" },
        ],
      },
      {
        day: "3일차",
        ...
        items: [
          ...
          { time: "11:00~12:00", place: "호텔", transport: "🚿", activity: "샤워 / 외출 준비" },
          { time: "12:00~13:00", place: "Española Way", transport: "🚶", activity: "Española Way 산책 (호텔 도보 5분)" },
          { time: "13:00~14:00", place: "Española Way", transport: "🍽️", activity: "점심 (Hosteria Romana 또는 A La Folie 크레페 워크인)", memo: "🍽️ Española Way 점심 (워크인)\n• Hosteria Romana — 정통 이탈리안 파스타\n• A La Folie Café — 프렌치 크레페 (가벼움)\n• Oh! Mexico — 멕시칸 패티오, 마가리타\n• 저녁 Tropezón 예약이라 점심은 가볍게" },
          { time: "14:00~17:00", place: "호텔", transport: "🏖️", activity: "호텔 풀·비치 + 휴식 (마지막 마이애미)", memo: "🏖️ 마지막 마이애미 오후\n• 베이사이드 다운타운까지 우버 30분 → 시간 빡빡해서 제외\n• 호텔 풀·비치에서 천천히 쉬기\n• 룸서비스 무알콜 음료·과일\n• 짐 미리 정리 시작 가능" },
          { time: "17:00~18:00", place: "호텔", transport: "🚿", activity: "샤워 / Tropezón 갈 준비" },
          { time: "18:00~20:00", place: "Tropezón", transport: "🍷", activity: "🥘 Tropezón (Española Way) 18시 예약 ✓", memo: "🥘 Tropezón — 18:00 예약 ✓\n• Española Way (호텔 도보 5분)\n• 스페인 타파스 + 산그리아\n• 추천: Patatas Bravas, Croquetas, Pulpo a la Gallega (문어), Paella (2인)\n• 산그리아 1피처 (2인 충분)\n• 야외석 인기 — 예약 시 outdoor 요청했는지 확인\n• 팁 18~20% — 영수증 'Service Charge' 확인\n• 5am 기상이라 20시 전 마무리 권장" },
          { time: "20:00~21:00", place: "호텔", transport: "🚶", activity: "호텔 복귀 / 마지막 산책 (오션드라이브 야경)" },
          { time: "21:00~22:00", place: "호텔", transport: "🧳", activity: "짐 정리 / LA 행 준비 (5am 기상)" },
        ],
      },
      {
        day: "4일차",
    ...
    days: [
      ...
      },
      {
        ...
        items: [
          ...
          { time: "18:00~19:30", place: "Last Bookstore", transport: "🚶", activity: "래스트 북스토어 (천천히)", memo: "📚 The Last Bookstore\n• 453 S Spring St\n• 책 터널·책 아치 사진 명소\n• 2층 'Labyrinth' 미로 (무료)\n• 영업 종료 21시" },
          { time: "19:30~20:30", place: "→ Airbnb", transport: "🚗", activity: "숙소 복귀 (다운타운 → Glendale 20~30분)" },
        ],
      },
      {
        day: "4일차",
        ...
        subtitle: "",
        items: [
          { time: "08:00~09:00", place: "Airbnb", transport: "☕", activity: "기상 / 셀프 아침" },
          { time: "09:00~10:00", place: "→ Getty Center", transport: "🚗", activity: "Getty Center 이동" },
          { time: "10:00~14:00", place: "Getty Center", transport: "🎨", activity: "게티 미술관 (점심 포함)", memo: "🎨 Getty Center\n• 입장 무료, 주차 예약 완료 ($37,750)\n• 트램 타고 미술관 진입 (무료)\n• 정원·건축·컬렉션\n• 점심: Cafe (캐주얼) 또는 Restaurant (예약제)\n• 사진 명소: Central Garden, 옥상 테라스\n• 6/12 금요일 정상 영업 ✓" },
          { time: "14:00~16:00", place: "Getty Center", transport: "🎨", activity: "Getty 자유 관람 + 정원 사진" },
      ...
      },
      {
        ...
        subtitle: "출국",
        items: [
          { time: "06:00~07:00", place: "Airbnb", transport: "🧳", activity: "기상 / 짐 최종 정리", memo: "🧳 출국 체크리스트\n• 면세한도 $800/인 (초과 시 신고)\n• 술 1L 1병, 담배 1보루까지\n• 한국 반입 금지: 육포·소시지·생과일\n• 액체 100ml 이하만 기내\n• 보조배터리·노트북·필름카메라 = 무조건 기내" },
...
export const reservations: Reservation[] = [
  ...
  { city: "마이애미", cityEmoji: "🏖️", category: "맛집", item: "Joe's Stone Crab", time: "6/7 17:00", bookingSite: "joesstonecrab.com", bookingUrl: "https://www.joesstonecrab.com", cost: "₩151,000", status: "완료", memo: "6/7 17:00 예약 (6/8 월 휴무라 일요일로 이동)" },
  ...
  { city: "마이애미", cityEmoji: "🏖️", category: "다이닝", item: "Tropezón (Española Way)", time: "6/8 18:00", bookingSite: "OpenTable", bookingUrl: "https://www.opentable.com", cost: "₩150,000", status: "완료", memo: "스페인 타파스 + 산그리아. 마지막 마이애미 밤 저녁" },
