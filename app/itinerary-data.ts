    ...
    days: [
      ...
      },
      {
        ...
        items: [
          ...
          { time: "15:00~16:00", place: "→ DUMBO", transport: "🚇", activity: "메트 → DUMBO 이동 (F선 또는 우버, ~45분)" },
          { time: "16:00~17:00", place: "DUMBO, Brooklyn", transport: "👗", activity: "DUMBO 도착 + 의상 갈아입기·헤어 보완", memo: "👗 스냅 준비\n• 의상은 아침에 가방에 챙겨서 출발 (호텔 왕복 X)\n• DUMBO 화장실 적음 → 카페·식당 이용 (Brooklyn Roasting Co. 등)\n• 메이크업 수정·헤어 정돈\n• F선 York St역 하차 도보 5분" },
