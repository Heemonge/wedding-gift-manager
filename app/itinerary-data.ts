    ...
    days: [
      ...
      },
      {
        ...
        items: [
          ...
          { time: "16:00~17:00", place: "호텔 풀", transport: "🏊", activity: "수영장 풀파티 (짧게)", memo: "🏊 Loews Pool — 디너 일찍이라 1시간만\n• 풀파티 분위기만 살짝\n• 17시 칼같이 나와서 샤워" },
          { time: "17:00~17:30", place: "호텔", transport: "🚿", activity: "샤워 / 옷 갈아입기 (Joe's 갈 준비)" },
          { time: "17:30~19:30", place: "Joe's Stone Crab", transport: "🦀", activity: "🦀 Joe's Stone Crab (오픈 직후 입장)", memo: "🦀 Joe's Stone Crab — 오픈 직후 워크인 ✓\n• 11 Washington Ave (호텔 도보 15분 또는 우버 5분)\n• 일요일 5pm 오픈 — 4:45~5:00 도착\n• ⚠️ 예약 안 받음, 가장 일찍 가야 대기 짧음 (그래도 30분~1시간)\n• 이름 등록 후 바 또는 외부 대기\n• 6월은 스톤크랩 비시즌 (10/15~5/1 시즌) — 냉동 또는 메뉴 변경 가능\n• 시즌이라도 시그니처: Stone Crab Claws (소·중·대·점보)\n• 비시즌 대체: 피쉬, 스테이크, 크랩 케이크\n• 디저트 무조건: Key Lime Pie\n• 드레스코드: 비즈니스 캐주얼 (반바지 X)\n• 1인 $80~150, 카드 OK, 팁 20% 흔함" },
          { time: "20:00~21:00", place: "호텔", transport: "🚖", activity: "호텔 복귀 + 칵테일 준비" },
...
export const reservations: Reservation[] = [
  ...
  { city: "마이애미", cityEmoji: "🏖️", category: "맛집", item: "Joe's Stone Crab", time: "6/7 17:30", bookingSite: "워크인", bookingUrl: "https://www.joesstonecrab.com", cost: "₩151,000", status: "주의", memo: "월요일 휴무라 6/7(일)로 이동. 워크인만 — 5pm 오픈 직후 4:45 도착" },
